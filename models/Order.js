...
const OrderSchema = new mongoose.Schema({
    ...
    city: { type: String, required: true }, // Address for the order
    pincode: { type: String, required: true }, // Address for the order
    phone: { type: String, required: true }, // Address for the order
    name: { type: String, required: true }, // Address for the order
